...
S(z) = \frac{x(0)}{r-1}\left(\frac{r}{1-rz^{-1}} - \frac{1}{1-z^{-1}}\right) 
\end{align}
To find S(2z) using the time-shifting property,  
\begin{align}
S(n) \stackrel{\text{z}}{\xleftrightarrow{}} S(z)
\end{align}
\begin{align}
S(2n) \stackrel{\text{z}}{\xleftrightarrow{}} S(z^2)
\end{align}
Now, substitute z with $z^2$ in the expression for S(z):
\begin{align}
S(z^2) = \frac{x(0)}{r-1}\left(\frac{r}{1-rz^{-2}} - \frac{1}{1-z^{-2}}\right) 
\end{align} 
